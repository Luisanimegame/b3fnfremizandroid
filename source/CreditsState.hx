...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		songs.push(new CredsMetadata("DuckierKarma", 5, ''));
		...
		songs.push(new CredsMetadata("Android Port", 10, 'title'));
		songs.push(new CredsMetadata("GagboWuz", 7, ''));
		songs.push(new CredsMetadata("Idklool", 7, ''));
		...
		{
			var leng = 0;
			if (songs[i].songCharacter == "title") leng = 50;
			var songText:Alphabet = new Alphabet(0, (20 * i) + leng, songs[i].songName, songs[i].songCharacter == "title", false);
			if (songs[i].songCharacter == "title")  songText.offset.y = -100;
	...
	override function update(elapsed:Float)
	{
		...
		if (accepted)
		{
			...
			switch(songs[curSelected].songName){
				...
				case "CelShader":
				FlxG.openURL('https://twitter.com/CELSHDR');
				case "Biddle":
				FlxG.openURL('https://twitter.com/Biddy312');
				case "Jams":
				FlxG.openURL('https://twitter.com/jams3d');
				case "Moisty":
				FlxG.openURL('https://youtube.com/channel/UC7M0aIL8-eVSJker9p0OyUQ');
				case "GagboWuz":
				FlxG.openURL('https://www.youtube.com/@GaboBooX');
				case "Idklool":
				FlxG.openURL('https://www.youtube.com/@idklool122');
